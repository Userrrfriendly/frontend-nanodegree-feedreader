...
$(function () {
    ...
    describe('RSS Feeds', function () {
         ...
         */
        it('each feed has URLs that defined and not empty', function () {
    ...
    describe('The menu', function () {
         ...
         */
        it('displays menu when clicked & hides the menu when clicked again', function () {
    ...
    describe('Initial Entries', () => {
         ...
         */
        it('renders at least a single .entry element within the .feed container', function () {
            expect($('.entry')[0].parentElement.parentElement.classList.contains('feed')).toBeTruthy();
        });
    });
